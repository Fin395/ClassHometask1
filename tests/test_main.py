def test_init_first_product(first_product):
...
def test_init_second_product(second_product):
...
def test_init_third_product(third_product):
...
def test_init_forth_product(forth_product):
